    ...
    return( 
         <div id="wrapper"> 
                    {/*  Sidebar */} 
                        ...
                        <li className={routeContext.routeContext.includes("solved")?"nav-item active":"nav-item"}>
                        ...
                        <li className={routeContext.routeContext.includes("listComplained")||routeContext.routeContext.includes("verifikasi")||routeContext.routeContext.includes("transfer")?"nav-item active":"nav-item"}>
                        ...
                        <li className={routeContext.routeContext.includes("penyelesaian")?"nav-item active":"nav-item"} > 
                        ...
                        <div id="content">
                            ...
                            <div className="container-fluid"> 
                                <Switch>   
                                    ...
                                    <Route exact path="/user/complained/penyelesaian/detail/:no_komplain">
                                        <UserDetailPenyelesaian/>
                                    </Route>
                                    <Route exact path="/user/complained/penyelesaian">
                                        <UserListPenyelesaianKomplain/>
                                    </Route>
                                    <Route exact path="/user/complained/verifikasi/:no_komplain">
                                        <UserVerifikasiPage/>
                                    </Route>
                                    <Route exact path="/user/complained/transfer/:no_komplain">
                                        <UserTransferPage/>
                                    </Route>
