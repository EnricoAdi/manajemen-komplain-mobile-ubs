            ...
            <div id="wrapper"> 
                       {/*  Sidebar */} 
                           ...
                           <li className={routeContext.routeContext.includes("dashboard")?"nav-item active":"nav-item"}> 
                               <Link className="nav-link" to="/gm/dashboard">
                           ...
                           <li className={routeContext.routeContext.includes("complain")?"nav-item active":"nav-item"}> 
                               <Link className="nav-link" to="/gm/complain/list">
                       ...
                       <div id="content-wrapper" className="d-flex flex-column">
                           ...
                           <div id="content">
                               ...
                               <div className="container-fluid"> 
                                   <Switch>   
                                       <Route exact path="/gm/complain/detail/:no_komplain">
                                           <GMDetailComplain/>
                                       </Route>  
                                       <Route path="/gm/complain/list">
                                           <GMListComplain/>
                                       </Route> 
                                       <Route exact path="/gm/dashboard">
                                           <GMDashboard/>
                                       </Route>
                                       <Route path="/gm">
                                           <Redirect to="/gm/dashboard"/>
                                       </Route>
                                   </Switch>
